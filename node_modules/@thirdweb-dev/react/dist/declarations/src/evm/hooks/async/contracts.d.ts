...
import { ContractEvent, ContractForPrebuiltContractType, ContractType, EventQueryFilter, PrebuiltContractType, SUPPORTED_CHAIN_ID, ThirdwebSDK, ValidContractInstance } from "@thirdweb-dev/sdk";
...
declare function fetchContractType(contractAddress: RequiredParam<ContractAddress>, sdk: RequiredParam<ThirdwebSDK>): Promise<"custom" | "split" | "edition-drop" | "edition" | "marketplace" | "multiwrap" | "nft-collection" | "nft-drop" | "pack" | "signature-drop" | "token-drop" | "token" | "vote" | null>;
