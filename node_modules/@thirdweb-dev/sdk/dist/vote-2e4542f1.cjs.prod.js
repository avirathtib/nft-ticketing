...
var paperXyz = require('./paper-xyz-8cd26f5d.cjs.prod.js');
...
class Vote {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new paperXyz.ContractWrapper(network, address, abi, options);
    ...
    this.metadata = new paperXyz.ContractMetadata(this.contractWrapper, paperXyz.VoteContractSchema, this.storage);
  ...
  async getProposalVotes(proposalId) {
    ...
    return [{
      type: paperXyz.VoteType.Against,
      label: "Against",
      count: votes.againstVotes
    }, {
      type: paperXyz.VoteType.For,
      label: "For",
      count: votes.forVotes
    }, {
      type: paperXyz.VoteType.Abstain,
      label: "Abstain",
  ...
  async balanceOfToken(tokenAddress) {
    ...
    return await paperXyz.fetchCurrencyValue(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
  /**
  ...
  async settings() {
    ...
    const votingTokenMetadata = await paperXyz.fetchCurrencyMetadata(this.contractWrapper.getProvider(), votingTokenAddress);
    return {
