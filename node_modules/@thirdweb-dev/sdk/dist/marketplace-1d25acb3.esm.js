...
import { cn as ContractWrapper, ah as ContractMetadata, cq as MarketplaceContractSchema, ai as ContractRoles, ag as ContractEncoder, aR as GasCostEstimator, aO as MarketplaceDirect, aP as MarketplaceAuction, aS as ContractEvents, aU as ContractPlatformFee, aT as ContractInterceptor, bh as ListingNotFoundError, a$ as ListingType, bt as getRoleHash, cr as mapOffer, a_ as DEFAULT_QUERY_ALL_COUNT } from './paper-xyz-f6b19dee.esm.js';
...
class Marketplace {
  ...
  async getOffers(listingId) {
    ...
    const offers = await Promise.all(listingEvents.map(async e => {
      const offer = await mapOffer(this.contractWrapper.getProvider(), BigNumber.from(listingId), {
