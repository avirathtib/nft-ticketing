import { N as NFTInputOrUriSchema, _ as _defineProperty } from './defineProperty-6292d8c3.esm.js';
import { cD as AddressSchema, cE as AmountSchema, cF as BigNumberishSchema, cG as RawDateSchema, aN as StandardErc1155, cn as ContractWrapper, aG as Erc1155, ah as ContractMetadata, cH as PackContractSchema, ai as ContractRoles, aj as ContractRoyalty, ag as ContractEncoder, aR as GasCostEstimator, aS as ContractEvents, aT as ContractInterceptor, aW as ContractOwner, bt as getRoleHash, ct as fetchCurrencyMetadata, cu as uploadOrExtractURI, cv as normalizePriceValue, cw as hasERC20Allowance, cx as isTokenApprovedForTransfer } from './paper-xyz-f6b19dee.esm.js';
import { z } from 'zod';
...
class Pack extends StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new ContractWrapper(network, address, abi, options.gasless && "openzeppelin" in options.gasless ? { ...options,
      gasless: {
