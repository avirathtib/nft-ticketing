...
class Pack extends paperXyz.StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new paperXyz.ContractWrapper(network, address, abi, options.gasless && "openzeppelin" in options.gasless ? { ...options,
      gasless: {
