...
class Edition extends paperXyz.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new paperXyz.ContractMetadata(this.contractWrapper, paperXyz.TokenErc1155ContractSchema, this.storage);
    this.roles = new paperXyz.ContractRoles(this.contractWrapper, Edition.contractRoles);
    ...
    this.signature = new paperXyz.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
    this.erc1155 = new paperXyz.Erc1155(this.contractWrapper, this.storage);
