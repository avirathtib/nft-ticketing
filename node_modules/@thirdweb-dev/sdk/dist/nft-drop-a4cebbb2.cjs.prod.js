...
class NFTDrop extends paperXyz.StandardErc721 {
  ...
  constructor(network, address, storage) {
    ...
    this.erc721 = new paperXyz.Erc721(this.contractWrapper, this.storage);
  ...
  async getAllClaimed(queryParams) {
    ...
    const count = ethers.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.count) || paperXyz.DEFAULT_QUERY_ALL_COUNT).toNumber();
  ...
  async prepareClaim(quantity, checkERC20Allowance) {
    return paperXyz.prepareClaim(quantity, await this.claimConditions.getActive(), async () => (await this.metadata.get()).merkle, 0, this.contractWrapper, this.storage, checkERC20Allowance);
  }
  /**
   * @internal
   */
