...
export declare class SmartContract<TContract extends BaseContract = BaseContract> implements UpdateableNetwork {
     ...
     */
    get erc1155(): Erc1155;
    constructor(network: NetworkOrSignerOrProvider, address: string, abi: ContractInterface, storage: ThirdwebStorage, options?: SDKOptions, contractWrapper?: ContractWrapper<TContract>);
